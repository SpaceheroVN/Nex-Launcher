...
class AboutDialog(QDialog):
    def __init__(self, parent=None, lang='EN'):
        ...
        version_label = QLabel(t.get('about_version', "Version 1.1"))
...
class SettingsDialog(QDialog):
    def __init__(self, current_settings, parent=None):
        ...
        self.notification_check = QCheckBox(t['show_system_notifications_check'])
        self.notification_check.setChecked(current_settings.get("show_system_notifications", True))
        ...
        self.detailed_categories_check.setChecked(current_settings.get("use_detailed_categories", False))
...
class AddSoftwareDialog(QDialog):
    def __init__(self, parent=None, lang='EN', settings=None):
        ...
        category_label_text = t['item_category_label'] if use_detailed else t['item_type_label']
        layout.addWidget(QLabel(category_label_text))
        
        self.type_combo = QComboBox(self)
        if use_detailed:
            self.categories = DETAILED_CATEGORIES[self.lang]
    ...
    def get_data(self):
        ...
        if use_detailed:
            ...
            item_type = self.categories[category]
            return name, item_type, category
        else:
