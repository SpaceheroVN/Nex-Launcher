...
TRANSLATIONS = {
    'Uninstaller': {
        'VN': {
            ...
            'estimated_size_tooltip': "Kích thước này được ước tính bằng cách quét thư mục cài đặt.",
            'estimated_date_tooltip': "Ngày này là ngày tạo thư mục cài đặt và có thể không chính xác."
        },
        'EN': {
            ...
            'estimated_size_tooltip': "This size is an estimate by scanning the installation directory.",
            'estimated_date_tooltip': "This date is the folder creation date and may be inaccurate."
        }
    }
}
...
def get_theme_colors(theme_name: str) -> dict:
    if theme_name == "Light":
        return {
            "window_bg": "#f3f3f3", "text_color": "#000000", "primary_color": "#D20103",
            "primary_hover_bg": "#B80103",
            ...
            "scroll_handle_hover": "#bbbbbb", "row_hover_bg": "#f5e7e6", "row_hover_border": "#D20103",
            "status_uninstalling": "#0078d7", "status_completed": "#28a745",
            "status_failed": "#D20103", "status_waiting": "#888888", "header_text": "#333333",
            "header_hover_bg": "#e0e0e0",
            "estimated_size_color": "#b28c00"
        }
    else: # Dark
        return {
            "window_bg": "#202020", "text_color": "#e0e0e0", "primary_color": "#D20103",
            "primary_hover_bg": "#B80103",
            ...
            "scroll_handle_hover": "#5a5a5a", "row_hover_bg": "#4b3a3a", "row_hover_border": "#D20103",
            "status_uninstalling": "#61afef", "status_completed": "#5cb85c",
            "status_failed": "#D20103", "status_waiting": "#888888", "header_text": "#d0d0d0",
            "header_hover_bg": "#3a3f4b",
            "estimated_size_color": "#ffd700"
        }
...
def get_uninstaller_style(theme_name: str) -> str:
    ...
    fix_style = "QWidget#rowContainer > *, QWidget#headerContainer > * { background-color: transparent; }"
    ...
    specific_styles = f"""
        ...
        QLabel#publisherLabel, QLabel#statusLabel {{ font-size: 10pt; color: {'#555' if theme_name == 'Light' else '#a0a0a0'}; }}
        QLabel#sizeLabel, QLabel#dateLabel {{ font-size: 10pt; color: {'#555' if theme_name == 'Light' else '#a0a0a0'}; }}
        QLabel#sizeLabel[is_estimate="true"], QLabel#dateLabel[is_estimate="true"] {{
            color: {c['estimated_size_color']};
            font-weight: bold;
        }}
        QWidget#headerContainer {{ background-color: {c['header_bg']}; border-bottom: 2px solid {c['container_border']}; }}
        QWidget#headerWidget {{ border-radius: 5px; }}
        QWidget#headerWidget:hover {{ background-color: {c['header_hover_bg']}; }}
        QLabel#headerLabel {{
            font-weight: bold;
            color: {c['header_text']};
            background-color: transparent;
        }}
        QLabel#sortIndicator {{
            background-color: transparent;
            border: 1.5px solid transparent;
            border-radius: 6px;
        }}
        QLabel#sortIndicator[sort_order="asc"] {{ border-bottom-color: {c['text_color']}; }}
        QLabel#sortIndicator[sort_order="desc"] {{ border-top-color: {c['text_color']}; }}
